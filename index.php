...
<body>
  ...
  ?>
    <section id="heroSection" class="h-v-full d-flex align-center <?php if (isset($_SESSION['username'])) {
                                                                  echo 'mb-5';
                                                                } ?>">
        <div class="d-flex">
            <div class="col-6 d-flex align-center">
                <div>
                    <div class="mb-3">
                        ...
                        <p class="hero-description align-justify">Raja iblis telah dikalahkan, dan grup para pahlawan
                            kembali ke
                            rumah
                            sebelum
                            dibubarkan. Frieren si
                            penyihir,
                            Himmel sang pahlawan, Pendeta Heiter, dan Eisen sang pejuang mengenang perjalanan panjang
                            mereka sembari
                            tibanya momen untuk saling mengucapkan selamat tinggal. Tapi, alur waktu berjalan berbeda
                            untuk ras elf,
                            dan
                    ...
                    <a href="<?php if (!isset($_SESSION['username'])) {
                      ...
                      echo '#charaSection';
                    } ?>" class="btn hero-btn">Read More</a>
                </div>
            </div>
    ...
    <section id="charaSection" <?php if (!isset($_SESSION['username'])) {
                                echo 'hidden';
                              } ?> class="ptb-4 mb-5">
        ...
        <div class="img-selection-container d-flex justify-content-between">
            <div class="">
                <img src="assets/imgs/frieren.png" alt="Frieren" width="110" height="140"
                    class="fit-cover chara-selection" onclick="selectImage(0)">
            </div>
            <div class="">
                <img src="assets/imgs/fern.png" alt="Fern" width="110" height="140" class="fit-cover chara-selection"
                    onclick="selectImage(1)">
            </div>
            <div class="">
                <img src="assets/imgs/stark.png" alt="Stark" width="110" height="140" class="fit-cover chara-selection"
    ...
    <section <?php if (!isset($_SESSION['username'])) {
        ...
        class="ptb-4 mb-5 <?php if (isset($_SESSION['username'])) {
                                                                                                              echo 'd-flex';
                                                                                                            } ?> justify-content-center">
        <video src="assets/videos/frieren-trailer.mp4" type="video/mp4" controls autoplay muted loop
            class="w-90"></video>
    </section>
    <?php
